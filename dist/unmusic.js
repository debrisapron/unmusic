...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__playback_sequencer__ = __webpack_require__(16);
...
function Unmusic(audioContext = getDefaultAudioContext()) {
  let sequencer = Object(__WEBPACK_IMPORTED_MODULE_5__playback_sequencer__["a" /* default */])(audioContext)
  let player = Object(__WEBPACK_IMPORTED_MODULE_4__playback_player__["a" /* default */])(sequencer)
...
function Player(sequencer) {
  ...
  function sequencerEventsFrom(score) {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0_lodash_fp___default.a.last(events).time < length) events.push({ time: length })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_fp___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash_fp__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_waaclock__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_waaclock___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_waaclock__);
...
function Sequencer(ac) {
  let clock = new __WEBPACK_IMPORTED_MODULE_1_waaclock___default.a(ac, { toleranceEarly: 0.01 })
  let events = []
  let playing = false
  let tempo = 120
  let nextIndex
  ...
  function setEvents(eventsByTime) {
    ...
    events = __WEBPACK_IMPORTED_MODULE_0_lodash_fp___default.a.sortBy('[0]', eventsByTime).map(([time, cb], i, arr) => {
      let delta = i === 0 ? time : (time - arr[i - 1][0])
      return { time, delta, cb }
    })

    if (!playing) return
    let newLength = __WEBPACK_IMPORTED_MODULE_0_lodash_fp___default.a.last(events).time
    let oldLength = __WEBPACK_IMPORTED_MODULE_0_lodash_fp___default.a.last(oldEvents).time
...
var WAAClock = __webpack_require__(18)
